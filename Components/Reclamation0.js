...
export default class Reclamation extends React.Component {
         ...
         width:width}}>
             ...
             <TouchableOpacity  onPress={this._RetourEtape_4} style={{width:50}}>
               <View style={{paddingLeft:10}}>
                ...
                <Text style={{fontSize:16,fontWeight:'bold',maxHeight:45 ,}} >
                  description : {this.state.reclamation}
                </Text>
                </View>
  ...
  _NextEtap_4=()=> {
     this.setState({etape:4,isrec:false,isDisplayBoxEtape3:false, opactyinfo:0, isDisplayBoxEtape4:true})
   }
 /****************** Fin FunctionEtap 3 **********************/
         ...
         width:width}}>
             ...
             <TouchableOpacity  onPress={this._RetourEtape_2} style={{width:50}}>
              ...
              >
                <Image
                  style={ styles.image}
                  //source={{uri: 'http://www.commune-benarous.gov.tn/images/images/benarousmir.png'}}
  ...
  _NextEtap_3=()=> {
     this.setState({etape:3,isrec:false,isDisplayBoxEtape2:false, opactyinfo:0, isDisplayBoxEtape3:true})
   }
/****************** Fin FunctionEtap 2 **********************/

 /******************Function Etap 1 **********************/
  _NextEtap_2=()=> {
   this.setState({etape:2,isrec:false,isDisplayBoxEtape:false, opactyinfo:0, isDisplayBoxEtape2:true})
 }
  _RetourEtape_1 = () =>{
      this.setState({
    ...
    return (
      <View style={styles.container}>
        ...
        >
        {
          ...
          this.state.markers.map(marker => {
                  if(marker.type == 1 ) {
                      return(<MapView.Marker coordinate={marker.latlng}  image={pick1}  key={marker.id} /> );
                    }else if(marker.type == 2 ) {
                      return(<MapView.Marker coordinate={marker.latlng}  image={pick2}  key={marker.id} /> );
                    }else{
                      return(<MapView.Marker coordinate={marker.latlng}   key={marker.id} /> );
                    }
                })
      ...
      <Modal style={[styles.modal, styles.modal3]} onClosed={() => this.setState({ isOpenSuccess: false })} isOpen={this.state.isOpenSuccess}>
          <Text style={styles.modalTitre}>Votre réclamation à été envoyée avec succès</Text>
